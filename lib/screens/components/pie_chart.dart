...
class DonutAutoLabelChart extends StatelessWidget {
  ...
  factory DonutAutoLabelChart.withResults(List<ResultsByCountry> results) {
    return new DonutAutoLabelChart(
      _createResultsData(results),
      // Disable animations for image tests.
      animate: false,
    );
  }
  ...
  static List<charts.Series<ResultsByCountry, int>> _createResultsData(
    ...
    return [
      new charts.Series<ResultsByCountry, int>(
        ...
        data: results,
        // Set a label accessor to control the text of the arc label.
        labelAccessorFn: (ResultsByCountry row, _) =>
            '${row.totalVotes}: ${row.country}',
      )
    ];
  }
}
